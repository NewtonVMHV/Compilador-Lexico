...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableLexical.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lexico", "Token", "Linea", "IniCol", "EndCol", "Error"
            }
        ) {
    ...
    private void menuItemOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemOpenActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Comando abierto cancelado por el usuario.");
        }
    ...
    private void menuItemLexicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemLexicActionPerformed
        ...
        if ( textPaneAreaEdit.getText() != "" )
            ...
            JOptionPane.showMessageDialog(null, "Error ! Sin texto! Necesitas llenar el área de texto !");
        
        
        populateLexicalTable(listAnalyse);
        
        if ( listAnalyse.get( listAnalyse.size() - 1).getLexeme().equals("Error") )
            JOptionPane.showMessageDialog(null, "Error ! Te perdiste cerca del comentario !");
        else
            JOptionPane.showMessageDialog(null, "Análisis léxico realizado con éxito!");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        about.setTitle("Acerca");
        about.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
        textPaneAreaEdit.setText("");
        eliminar();
        textAreaLines.setText("");    
    }//GEN-LAST:event_jMenuItem2ActionPerformed
    public void eliminar(){
        DefaultTableModel tb = (DefaultTableModel) tableLexical.getModel();
        int a = tableLexical.getRowCount()-1;
        for (int i = a; i >= 0; i--) {           
